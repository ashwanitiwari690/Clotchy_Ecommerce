...
export class AppService<T> {
  ...
  public getOption(data: string): Observable<any> {
    console.log(APIURL + this.appmod + "/" + data);
    return this.http.get<any>(APIURL + this.appmod, { headers: { "Content-Type": "application/json" }, params: { type: data } });
  }

  public getOptionParams(data: any, filter: any): Observable<any> {
    return this.http.get<any>(APIURL + this.appmod, { headers: { "Content-Type": "application/json" }, params: { type: data, data: filter } });
  }
  ...
  public getCiOption(url: string, key?: string): Observable<any> {
    if (key !== undefined && key !== null) {
      return this.http.get<any>(CIAPIURL + this.appmod + "/" + url, { headers: { "Content-Type": "application/json" }, params: { state: key } });
    } else {
      return this.http.get<any>(CIAPIURL + this.appmod + "/" + url);
    }
  }
  ...
  public getReport(data: string): Observable<any> {
    ...
    this.userkey =sessionStorage.getItem('type');
